...
<head>
    ...
    <link rel="stylesheet" href="../CSS/DeskMedico.css">
    <link rel="icon" href="../Img/Iconos/icon.png" />

    <title>Desk Medic</title>
</head>
...
<body onload="ImgAleatoria (), ImgBackgound()">
    ...
    <div class="contenedor-general">
        ...
        <div class="contenedor-registro">
            ...
            <form action="" class="FormPropietario">
            ...
            <form action="" class="FromMascota">
                <div class="registro-mascota02">
                    <img class="volver01" src="../Img/Iconos/volver.png">
                    <p>Consultar Propietario</p>
                    <input type="text" name="" id="" placeholder="Buscar por ID" class="buscarID-mascota">
                ...
                <input type="submit" name="AgregarPropMasc" class="RegistroProp02" value="Registrar">
            </form>
        </div>
    </div>
